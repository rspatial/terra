...
flowdir_f <- '/stablo/local/data/hydrosheds/flowdir/niger/nigrb_dir_3s.bil' ###   af_dir_30s.bil' ## path to Flowdir Raster
pourpoint_f <- '/stablo/local/data/hydrosheds/flowdir/niger/nigrb_pp_3s.shp' ## path to Pourpoint shapefile
pourpoint_30s_f <- '/stablo/local/data/hydrosheds/flowdir/PourPoint_wgs84_Niger.shp' ##   nigrb_pp_30s.shp' ## path to Pourpoint shapefile
