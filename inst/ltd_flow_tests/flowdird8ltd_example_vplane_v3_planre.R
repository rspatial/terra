...
# Model A: V-shape valley with longitudinal slope
##elev_f1 <-  "2.0*x+1.1 * y" ## "2.0*x*tanh(100*x) + 0.5*y"  ##"x^2+y^2" ##
elev_f1 <-  "2.0*x+y" ## "2.0*x*tanh(100*x) + 0.5*y"  ##"x^2+y^2" ##
# Model B: Smooth parabolic bowl with tilt
#elev_f2 <-  "2.0*x- 0.5*y" ## "2.0*x*tanh(100*x) - 0.5*y" ### (x^2+y^2)/100"  ###0.5*x*tanh(100*x) - 0.5*y"
#elev_f2 <-  "2.0*x- y" ## "2.0*x*tanh(100*x) - 0.5*y" ### (x^2+y^2)/100"  ###0.5*x*tanh(100*x) - 0.5*y"
elev_f2 <-  "2.0*x- 0.5*y" ## "2.0*x*tanh(100*x) - 0.5*y"
### ---------------------------------------------------------
...
r1$flow_lad05   <- flowdirD8ltd(r1$elev1, lambda=0.5, deviation_type=deviation_type)
...
r2$flow_lad05   <- flowdirD8ltd(r2$elev2, lambda=0.5, deviation_type=deviation_type)
