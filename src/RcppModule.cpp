...
*/
		...
		.method("warp", (SpatRaster (SpatRaster::*)(SpatRaster, std::string, std::string, bool, bool, bool, std::string, std::vector<double>, double, bool, double, double, std::vector<std::string>, SpatOptions&))(&SpatRaster::warper))
		.method("warp_by_util", (SpatRaster (SpatRaster::*)(SpatRaster, std::string, std::string, bool, bool, bool, std::string, std::vector<double>, double, bool, double, double, std::vector<std::string>, SpatOptions&))(&SpatRaster::warper_by_util))
