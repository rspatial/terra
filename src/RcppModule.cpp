...
//		.method("relate_between", ( std::vector<int> (SpatVector::*)(SpatVector, std::string, bool, bool))( &SpatVector::relate ))
		...
		.method("rectangles_lonlat", &SpatVector::rectangles_lonlat)
...
*/
		...
		.method("warp", (SpatRaster (SpatRaster::*)(SpatRaster, std::string, std::string, bool, bool, bool, std::string, std::vector<double>, double, bool, double, double, std::vector<std::string>, std::vector<std::string>, SpatOptions&))(&SpatRaster::warper))
		.method("warp_by_util", (SpatRaster (SpatRaster::*)(SpatRaster, std::string, std::string, bool, bool, bool, std::string, std::vector<double>, double, bool, double, double, std::vector<std::string>, std::vector<std::string>, SpatOptions&))(&SpatRaster::warper_by_util))
...
//		.method("zonal_old", &SpatRaster::zonal_old)
	...
	class_<SpatRasterStack>("SpatRasterStack")
		.constructor()
		.constructor<std::string, std::vector<int>, bool, std::vector<std::string>, bool, bool, std::vector<std::string>>()
		.constructor<std::string, std::vector<int>, bool, std::vector<std::string>, bool, bool, std::vector<std::string>, bool>()
