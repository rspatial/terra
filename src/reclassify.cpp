...
SpatRaster SpatRaster::reclassify(std::vector<std::vector<double>> rcl, unsigned right, bool lowest, std::string filename, std::string format, std::string datatype, bool overwrite) {
