// terra_module.cpp  — pybind11 bindings for the terra C++ core
...
PYBIND11_MODULE(_terra, m) {
    m.doc() = "terra: Python bindings for the terra geospatial C++ library";
    ...
    py::class_<SpatRaster>(m, "SpatRaster")
        ...
        .def("getDepthName",  &SpatRaster::getDepthName)
        .def("getDepthUnit",  &SpatRaster::getDepthUnit)
        .def("nsrc",          &SpatRaster::nsrc)
